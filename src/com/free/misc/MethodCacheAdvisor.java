...
public class MethodCacheAdvisor implements MethodInterceptor, InitializingBean, Ordered {
  ...
  @Around("execution(* com.free.zf.ajax.*.*(..)) " +
  		"|| execution(* com.free.zf.service.*.get*(..)) " +
  		"|| execution(* com.free.zf.service.*.list*(..)) " +
  		"|| execution(* com.free.zf.service.*.load*(..)) " +
  		"|| execution(* com.free.zf.service.*.query*(..))")
  ...
  @After("execution(* com.free.zf.service.*.add*(..)) " +
  		"or execution(* com.free.zf.service.*.delete*(..)) " +
  		"or execution(* com.free.zf.service.*.save*(..)) " +
  		"or execution(* com.free.zf.service.*.update*(..)) " +
  		"or execution(* com.free.zf.service.*.set*(..))")
