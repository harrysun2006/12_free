...
public class JettyWeb {
  ...
  public static void main(String[] args) throws Exception {
    String name = args.length > 0 ? args[0] : "zf";
    Mocker mocker = Mocker.init(name);
    String webXml = mocker.getWebXml();
    int port = mocker.getInt("web.port", 8001);
    ...
    Listener listerner = new Listener() {
      ...
      public void lifeCycleFailure(LifeCycle arg0, Throwable arg1) {
        logger.info("ZF SYSTEM {} FAILED!!!", Application.VERSION);
      }

      @Override
      public void lifeCycleStarted(LifeCycle arg0) {
        logger.info("ZF SYSTEM {} STARTED!", Application.VERSION);
      }

      @Override
      public void lifeCycleStarting(LifeCycle arg0) {
        logger.info("ZF SYSTEM {} STARTING...", Application.VERSION);
      }

      @Override
      public void lifeCycleStopped(LifeCycle arg0) {
        logger.info("ZF SYSTEM {} STOPPED!", Application.VERSION);
      }

      @Override
      public void lifeCycleStopping(LifeCycle arg0) {
        logger.info("ZF SYSTEM {} STOPPING...", Application.VERSION);
      }
    };
