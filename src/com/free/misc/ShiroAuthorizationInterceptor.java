...
public class ShiroAuthorizationInterceptor extends AnnotationsAuthorizingMethodInterceptor implements MethodInterceptor {

  public ShiroAuthorizationInterceptor() {
    ...
    interceptors.add(new ShiroRoleMethodInterceptor(resolver));
   ...
   *         result.
   * @throws Throwable
   *           if the underlying AOP Alliance <code>proceed()</code> call throws
  ...
  /**
   * Creates a Shiro {@link MethodInvocation MethodInvocation} instance and then
   * immediately calls
   * {@link org.apache.shiro.authz.aop.AuthorizingMethodInterceptor#invoke
   * super.invoke}.
   * 
   * @param methodInvocation
   *          the AOP Alliance-specific <code>methodInvocation</code> instance.
   * @return the return value from invoking the method invocation.
   * @throws Throwable
   *           if the underlying AOP Alliance method invocation throws a
   *           <code>Throwable</code>.
   */
